...
'Enter date as %(format)s': 'introducir la fecha como %(format)s',
'enter date as %(format)s': 'introducir la fecha como %(format)s',
...
'file ## download': 'archivo ## descargado',
...
'Group uniquely assigned to user %(id)s': 'Grupo asignado de forma exclusiva usuario %(id)s',
...
'Invalid reset password': 'Restablecimiento de contraseña no válida',
...
'Object or table name': 'Objeto o tabla de nombres',
...
'Registration successful': 'Registro Realizado',
...
'User %(id)s Password reset': 'usuario %(id)s de restablecimiento de contraseña',
'User %(id)s Registered': 'Usuario %(id)s Registrado',
'User %(id)s Verification email sent': 'Usuario %(id)s Correo electrónico de verificación enviado',
