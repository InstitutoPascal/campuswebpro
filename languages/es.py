...
'Enter a number between %(min)g and %(max)g': 'Introduzca un número entre% (min) y g% (max) g',
'Enter an integer between %(min)g and %(max)g': 'Introduzca un número entero entre% (min) y g% (max) g',
'enter an integer between %(min)g and %(max)g': 'introducir un número entero entre% (min) y g% (max) g',
